                                        ...
                                        <div class="trip-card">
                                            <div class="trip-card-container">
                                                ...
                                                <div class="trip-card-image">
                                                    <img src="<?php echo BASE_URL; ?>/public/uploads/images/banner-comfort.png" alt="<?php echo htmlspecialchars($trip['tenLoaiPhuongTien']); ?>" />
                                                </div>
                                                ...
                                                <div class="trip-card-content">
                                                    ...
                                                    <!-- Bottom section with dynamic ratings and services -->
                                                    <div class="trip-card-footer">
                                                        <div class="trip-ratings">
                                                            <div class="rating-item">
                                                                <div class="rating-label">Tài xế</div>
                                                                <div class="rating-stars">
                                                                    <i class="fas fa-star"></i>
                                                                    <span class="rating-value"><?php echo (isset($trip['avgDriver']) && $trip['avgDriver'] !== null && $trip['avgDriver'] !== '') ? number_format((float)$trip['avgDriver'], 1) : 'Chưa có'; ?></span>
                                                                </div>
                                                            </div>
                                                            <div class="rating-item">
                                                                <div class="rating-label">Phương tiện</div>
                                                                <div class="rating-stars">
                                                                    <i class="fas fa-star"></i>
                                                                    <span class="rating-value"><?php echo (isset($trip['avgVehicle']) && $trip['avgVehicle'] !== null && $trip['avgVehicle'] !== '') ? number_format((float)$trip['avgVehicle'], 1) : 'Chưa có'; ?></span>
                                                                </div>
                                                            </div>
                                                            <div class="rating-item">
                                                                ...
                                                                <div class="rating-stars">
                                                                    <i class="fas fa-star"></i>
                                                                    <span class="rating-value"><?php echo (isset($trip['avgService']) && $trip['avgService'] !== null && $trip['avgService'] !== '') ? number_format((float)$trip['avgService'], 1) : 'Chưa có'; ?></span>
                                                                </div>
                                                            </div>
                                                            <?php if (!empty($trip['totalRatings']) && (int)$trip['totalRatings'] > 0): ?>
                                                                <div class="rating-count">(<?php echo (int)$trip['totalRatings']; ?> đánh giá)</div>
                                                            <?php endif; ?>
                                                        </div>
