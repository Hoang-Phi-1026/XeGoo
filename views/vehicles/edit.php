            ...
            <div class="form-grid">
                    ...
                    <select name="loaiPhuongTien" id="loaiPhuongTien" required>
                        ...
                        <?php foreach ($vehicleTypes as $key => $value): ?>
                            <option value="<?php echo $key; ?>" 
                                    <?php echo (isset($_SESSION['form_data']['loaiPhuongTien']) ? 
                                        ($_SESSION['form_data']['loaiPhuongTien'] == $key ? 'selected' : '') : 
                                        ($vehicle['loaiPhuongTien'] == $key ? 'selected' : '')); ?>>
                                <?php echo $value; ?>
                            </option>
                        <?php endforeach; ?>
                    </select>
                ...
                <div class="form-group">
                    ...
                    <input type="number" name="soChoNgoi" id="soChoNgoi" min="1" max="100" required
                           value="<?php echo htmlspecialchars($_SESSION['form_data']['soChoNgoi'] ?? $vehicle['soChoNgoi']); ?>"
                ...
                <div class="form-group">
                    ...
                    <select name="loaiChoNgoi" id="loaiChoNgoi" required>
                        ...
                        <?php foreach ($seatTypes as $key => $value): ?>
                            <option value="<?php echo $key; ?>"
                                    <?php echo (isset($_SESSION['form_data']['loaiChoNgoi']) ? 
                                        ($_SESSION['form_data']['loaiChoNgoi'] == $key ? 'selected' : '') : 
                                        ($vehicle['loaiChoNgoi'] == $key ? 'selected' : '')); ?>>
                                <?php echo $value; ?>
                            </option>
                        <?php endforeach; ?>
                    </select>
